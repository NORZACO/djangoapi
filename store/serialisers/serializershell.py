 ...
 print(json.dumps(serializer.data, indent=3))
{
   "id": 1,
   "name": "programming",
   "description": "I'm sorry, I'm not sure what you want me to write about. Could you please provide me with more information or a specific topic to write about?",
   "price": 300.0,
